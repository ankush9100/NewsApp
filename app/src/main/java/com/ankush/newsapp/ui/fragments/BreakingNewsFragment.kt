...
import com.ankush.newsapp.adapters.NewsAdapter
...
class BreakingNewsFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        mainActivityViewModel = ViewModelProvider(this).get(NewsViewModel::class.java)
        mainActivityViewModel.getUser()!!.observe(this, Observer { serviceSetterGetter ->
            val msg = serviceSetterGetter.articles.get(0).author
            Toast.makeText(context,msg, Toast.LENGTH_LONG).show()
            val adapter = NewsAdapter(serviceSetterGetter)
